...
try
{      $metafield=$shopify('GET /admin/collections/#{id}/metafields.json');
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="exampleModalLabel">Collection Name</h4>
      </div>
      <div class="modal-body">
         <form>
          <div class="form-group">
            <label for="recipient-name" class="control-label">Meta field text</label>
            <input type="text" class="form-control" id="metafield1-text">
          </div>
          <div class="form-group">
            <label for="message-text" class="control-label">Meta field text</label>
            <textarea class="form-control" id="metafield2-text"></textarea>
          </div>
        </form>
      </div>
